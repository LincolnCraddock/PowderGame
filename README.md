...
## Parallel versions
### CUDA (Nvidia GPUs)
- [install CUDA using the developer guide](https://docs.nvidia.com/cuda/cuda-quick-start-guide/index.html), if not installed
- run ``make cuda`` to compile a cuda-capable executable
- run ``mainCuda.*``
### HIP (AMD GPUs)
- [install HIP using the developer guide](https://rocm.docs.amd.com/projects/HIP/en/latest/install/install.html), if not installed
